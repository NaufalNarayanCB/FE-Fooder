                ...
                <div className="relative">
                    <button onClick={toggleDropdown} className="flex items center space-x-2 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.252.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75" />
                        </svg>
                    ...
                    {isDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 top-full">
                            ...
                            <a href="#" onClick={handleLogout} className="block px-4 py-2 text-sm text-black hover:bg-gray-100">Logout Web</a>
                        </div>
                    )}
                </div>
            </header>
           ...
           bg-purple-600 border-r border-primary ${isShow ? `translate-x-full` : ``}`}>
                ...
                <div className="mb-3 w-full flex justify-center">
                    <div className="flex items-center space-x-2">
                        ...
                        <h1 className="text-2xl font-bold text-orange500">Cashier WizzMie</h1>
                    </div>
                </div>
                {/* end logo section */}
                ...
                <div className="w-full mt-10 mb-6 bg-primary text-white p-3 flex gap-2 items-center">
                    <Image src={Logo} alt="Profile" width={40} height={40} className="rounded-full" />
